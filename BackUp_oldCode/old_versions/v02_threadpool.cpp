// Version 2: Thread Pool Management
//
// Changes from V1:
// - Added activeThreads counter to limit parallel execution
// - Reduced maxParallelDepth from 8 to 6 (prevent stack overflow)
// - Added maxThreads based on hardware_concurrency
// - Move semantics for State struct
// - Better thread management with atomic counters
//
// Performance: ~10s for 8×8 (1.5× faster than V1)
// Problem: Still using std::async (overhead), no work-stealing
